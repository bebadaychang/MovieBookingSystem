...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 03, 2026 lúc 11:10 PM
...
INSERT INTO `bookings` (`id`, `user_id`, `showtime_id`, `total_price`, `status`, `created_at`, `ticket_code`) VALUES
(1, 1, 3, 240000.00, 'paid', '2026-07-03 17:49:34', 'TCK093B0821'),
(2, 1, 15, 160000.00, 'paid', '2026-07-03 17:50:47', 'TCK8F1F9566'),
(3, 1, 30, 800000.00, 'paid', '2026-07-03 18:20:51', 'TCK262AAFE8'),
(7, 2, 15, 240000.00, 'paid', '2026-07-03 20:52:20', 'TCK3315F502');
...
INSERT INTO `login_logs` (`id`, `user_id`, `ip_address`, `browser`, `login_time`) VALUES
(1, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-07-03 19:13:44'),
(2, 2, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-07-03 19:13:55'),
(3, 2, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-07-03 19:34:32'),
(4, 2, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-07-03 19:40:09'),
(5, 2, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-07-03 19:51:10'),
(6, 2, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-07-03 20:09:41');
...
(1, 'Avengers: Endgame', 'Sau sự kiện Thanos tiêu diệt một nửa sinh linh trong vũ trụ, các Avengers còn lại tập hợp để thực hiện kế hoạch cuối cùng nhằm đảo ngược hành động của hắn.', 'avengers.jpg', 'avengers.mp4', '2019', 'Hành động', 15803, '2026-07-03 17:49:00'),
(2, 'Spider-Man: No Way Home', 'Peter Parker đề nghị Tiến sĩ Strange xóa ký ức của mọi người về danh tính của mình, nhưng một phép thuật sai lầm đã mở ra đa vũ trụ đầy nguy hiểm.', 'spiderman.jpg', 'spiderman.mp4', '2021', 'Hành động', 14201, '2026-07-03 17:49:00'),
(3, 'Interstellar', 'Một nhóm phi hành gia du hành qua lỗ sâu băng không gian để tìm kiếm hành tinh mới có thể cứu nhân loại khỏi sự tuyệt chủng trên Trái Đất.', 'interstellar.jpg', 'interstellar.mp4', '2014', 'Khoa học viễn tưởng', 12500, '2026-07-03 17:49:00'),
(4, 'Titanic', 'Câu chuyện tình yêu bi thương giữa Jack và Rose trên con tàu sang trọng Titanic trong chuyến hành trình định mệnh vào năm 1912.', 'titanic.jpg', 'titanic.mp4', '1997', 'Tình cảm', 11000, '2026-07-03 17:49:00'),
(5, 'The Dark Knight', 'Batman đối mặt với Joker – kẻ hắc ám muốn nhấn chìm Gotham City vào hỗn loạn. Cuộc chiến giữa trật tự và vô chính phủ bắt đầu.', 'darkknight.jpg', 'darkknight.mp4', '2008', 'Hành động', 13400, '2026-07-03 17:49:00'),
(6, 'Inception', 'Dom Cobb là kẻ trộm kỳ tài có khả năng xâm nhập vào giấc mơ của người khác để đánh cắp bí mật. Anh nhận nhiệm vụ nguy hiểm nhất: cấy ghép ý tưởng.', 'inception.jpg', 'inception.mp4', '2010', 'Khoa học viễn tưởng', 10800, '2026-07-03 17:49:00'),
(7, 'Doraemon: Nobita và Mặt Trăng Thám Hiểm', 'Nobita và nhóm bạn cùng Doraemon bắt đầu cuộc phiêu lưu đến Mặt Trăng, nơi họ phát hiện ra một nền văn minh bí ẩn đang gặp nguy hiểm.', 'doraemon.jpg', 'doraemon.mp4', '2019', 'Hoạt hình', 9500, '2026-07-03 17:49:00'),
(8, 'Lật Mặt 7: Một Điều Ước', 'Bộ phim hài hành động Việt Nam kể về hành trình của một gia đình với những tình huống hài hước và cảm động, đầy ắp tiếng cười.', 'latmat7.jpg', 'latmat7.mp4', '2024', 'Hài', 8700, '2026-07-03 17:49:00'),
(9, 'The Conjuring', 'Dựa trên câu chuyện có thật về hai nhà ngoại cảm Ed và Lorraine Warren điều tra vụ ám ảnh kinh hoàng tại một trang trại ở Rhode Island.', 'conjuring.jpg', 'conjuring.mp4', '2013', 'Kinh dị', 9200, '2026-07-03 17:49:00'),
(10, 'Your Name', 'Hai học sinh trung học ở các vùng khác nhau của Nhật Bản kỳ lạ thay đổi cơ thể cho nhau qua những giấc mơ và dần nảy sinh tình cảm.', 'yourname.jpg', 'yourname.mp4', '2016', 'Tình cảm', 11511, '2026-07-03 17:49:00');
...
(1, 2, 5, 'Nguyễn Gia Huy', 5, 'Phim quá hay! Hành động mãn nhãn.', '2026-07-03 17:49:34'),
(2, 3, 5, 'Minh Anh', 4, 'Nội dung hấp dẫn, diễn xuất tốt.', '2026-07-03 17:49:34');
...
INSERT INTO `users` (`id`, `fullname`, `username`, `email`, `phone`, `password`, `avatar`, `role`, `status`, `remember_token`, `created_at`, `updated_at`, `login_attempts`, `lock_time`) VALUES
(1, 'Admin', 'admin', 'admin@gmail.com', '0123456789', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'default.png', 'admin', 'active', NULL, '2026-07-01 08:48:07', '2026-07-02 20:04:29', 0, NULL),
(2, 'Phạm Trương Anh Tú', 'Tu', 'anhtuquan.bd@gmail.com', '0934081499', '$2y$10$NKGmSc6f834tJLYRAvd0WOWdcc6/KbKOcOPK5pPENLrSJG1GXQp4G', 'default.png', 'user', 'active', NULL, '2026-07-01 09:28:02', '2026-07-02 20:20:29', 0, NULL);
